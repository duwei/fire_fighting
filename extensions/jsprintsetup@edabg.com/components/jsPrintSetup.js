...
//
//  Revision: 
//     $Id: jsPrintSetup.js,v 1.16 2011/08/18 19:41:36 mitko Exp $ 
//
...
// Common private methods
	...
	getWindow: function () {
		...
		var rt = wm.getMostRecentWindow('navigator:browser');
		if(rt) return rt;
		//rt = this.prefManager.copyUnicharPref("toolkit.singletonWindowType");
		if(rt == null) rt="myXUL:browser";
		return wm.getMostRecentWindow(rt);
	},
