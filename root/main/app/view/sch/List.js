    ...
    initComponent: function() {
        Ext.apply(this, {
            ...
            columns: [
				...
				{text: '党团时间',	dataIndex:'党团时间',	width:80, renderer:FV.lib.KeyMapMng.formatDate },
				{text: '政治面貌',	dataIndex:'政治面貌',	width:60 },
				{text: '学历',	dataIndex:'学历',	width:80 },
				//{text: '培训形式',	dataIndex:'培训形式',	width:100 },
				{text: '专业',	dataIndex:'专业',	width:120 },
				{text: '行政职务等级',	dataIndex:'行政职务等级',	width:90 },
				{text: '职务等级时间',	dataIndex:'职务等级时间',	width:90, renderer:FV.lib.KeyMapMng.formatDate },
				{text: '警衔文级',	dataIndex:'警衔文级',	width:60 },
				{text: '衔级时间',	dataIndex:'衔级时间',	width:80, renderer:FV.lib.KeyMapMng.formatDate },
				{text: '技术等级',	dataIndex:'技术等级',	width:80 },
				{text: '技术等级时间',	dataIndex:'技术等级时间',	width:80, renderer:FV.lib.KeyMapMng.formatDate },
				{text: '技术职务',	dataIndex:'技术职务',	width:100 },
				{text: '技术职务时间',	dataIndex:'技术职务时间',	width:80, renderer:FV.lib.KeyMapMng.formatDate },
				{text: '技术资格',	dataIndex:'技术资格',	width:100 },
				{text: '初评资格时间',	dataIndex:'初评资格时间',	width:80, renderer:FV.lib.KeyMapMng.formatDate },
				{text: '籍贯',	dataIndex:'籍贯',	width:100 },
				{text: '警官证号码',	dataIndex:'警官证号码',	width:80 }
			],
            dockedItems:[{
                xtype: 'toolbar',
                dock: 'top',
